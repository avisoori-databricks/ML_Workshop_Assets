...
# MAGIC %md
# MAGIC # Building Reliable Data Lakes with Delta Lake and Apache Spark™
# MAGIC 
...
# MAGIC * You need DBR 7.6 or above.
# MAGIC 
# MAGIC ### Source
...
# MAGIC %md
# MAGIC ## ![Delta Lake Tiny Logo](https://pages.databricks.com/rs/094-YMS-629/images/delta-lake-tiny-logo.png) Let's explore the data.
