...
white_wine = pd.read_csv("/dbfs/FileStore/shared_uploads/avinash.sooriyarachchi@databricks.com/winequality_white-3.csv", sep=';')
red_wine = pd.read_csv("/dbfs/FileStore/shared_uploads/avinash.sooriyarachchi@databricks.com/winequality_red__1_.csv", sep=';')
