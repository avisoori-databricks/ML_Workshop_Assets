...
# MAGIC 
# MAGIC ## Instructions 
# MAGIC Fill in the gaps as instructed during the training. You will be instructed to include initials in model, run and table names 
...
# MAGIC %md
# MAGIC ## Please note that:
# MAGIC #### A run is a collection of parameters, metrics, labels, and artifacts related to the training process of a machine learning model.
# MAGIC #### An experiment is the basic unit of MLflow organization. All MLflow runs belong to an experiment. 
